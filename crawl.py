...
class SpiderThread(threading.Thread):
	...
	def __init__(self,target,url,logfile,module,output,waf):
	...
	def run(self):
		...
		for i in tmp_link_list:
			if urllib.parse.urlparse(self.target).netloc == urllib.parse.urlparse(i).netloc:
				link_list.append(i)
